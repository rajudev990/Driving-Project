                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    ...
                                    <input required value="{{$data->company_name}}" type="text" name="company_name" class="form-control @error('company_name') is-invalid @enderror" id="company_name" placeholder="Website Name">
                                    @error('company_name')
                                ...
                                <div class="col-lg-6 form-group">
                                    ...
                                    <input value="{{$data->address}}" type="text" name="address" class="form-control @error('address') is-invalid @enderror" id="address" placeholder="Address">
                                    @error('address')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-6 form-group">
                                    ...
                                    <input value="{{$data->facebook}}" type="text" name="facebook" class="form-control @error('facebook') is-invalid @enderror" id="facebook" placeholder=" Facebook Link">
                                    @error('facebook')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                <div class="col-lg-6 form-group">
                                    <label for="twitter">Messenger</label>
                                    <input value="{{$data->twitter}}" type="text" name="twitter" class="form-control @error('twitter') is-invalid @enderror" id="twitter" placeholder="Messenger">
                                    @error('twitter')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-6 form-group">
                                    <label for="linkedin">Telegram</label>
                                    <input value="{{$data->linkedin}}" type="text" name="linkedin" class="form-control @error('linkedin') is-invalid @enderror" id="linkedin" placeholder="Telegram">
                                    @error('linkedin')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                <div class="col-lg-6 form-group">
                                    ...
                                    <input value="{{$data->youtube}}" type="text" name="youtube" class="form-control @error('youtube') is-invalid @enderror" id="youtube" placeholder="WhatsApp">
                                    @error('youtube')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-6 form-group">
                                    <label for="instagram">Coockies Text</label>
                                    <input value="{{$data->instagram}}" type="text" name="instagram" class="form-control @error('instagram') is-invalid @enderror" id="instagram" placeholder="Coockies Text">
                                    @error('instagram')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                <div class="col-lg-6 form-group">
                                    ...
                                    <input value="{{$data->copyright}}" type="text" name="copyright" class="form-control @error('copyright') is-invalid @enderror" id="copyright" placeholder="Copy Right">
                                    @error('copyright')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
